...
class SearchNode:
    ...
    def __init__(self, state, parent, action, g, name, good=0):
        """
...
def make_root_node(initial_state):
    ...
    """
    return SearchNode(initial_state, None, None, 0, 'START')


def make_child_node(parent_node, action, state, a):
    """
    ...
    """
    node = SearchNode(state, parent_node, action, parent_node.g + 1, a)
    #    parent_node.sons.append(node)
    return node
